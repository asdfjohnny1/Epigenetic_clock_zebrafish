...
#SBATCH --job-name=L_S6_cluster_array
...
#SBATCH -o $PROJECT_ROOT/multitissue/making_clocks/R/log/cluster/L_S6_cluster_array-%A-%a.out
#SBATCH -e $PROJECT_ROOT/multitissue/making_clocks/R/log/cluster/L_S6_cluster_array-%A-%a.err
...
srun Rscript $PROJECT_ROOT/multitissue/making_clocks/R/scripts/array/post_evolution/new/Cluster_step6_lasso_final_new.R $INPUT_FILE
